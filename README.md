...
# Installation
  ...
  - PyPI Install
    ...
    - Install a *specific version of EFN*
      ...
      > ***NOTE: there are some versions of EFN, that the versions' number changed (v4.1.1 (**GitHub**) -> v4.1.1.0 (**PyPI**), v4.3 (**GitHub**) -> v4.3.0 (**PyPI**)), due to an error, so if you wanna install a *specific version of EFN using PyPI*, then check the versions' number in (EFN's PyPI project)[https://pypi.org/project/EFN/].***

# EFN's wiki
EFN's wiki is a documentation that shows the story of EFN and code examples like: write("This is an example.") -> prints "This is an example". You can view the story [here](https://github.com/Takax62/EFN/wiki/The-story-of-EFN/) and the examples wiki: [here](https://github.com/Takax62/EFN/wiki/Learning-EFN/). There are some documentations that show up in the [release notes](https://github.com/Takax62/EFN/releases/).
